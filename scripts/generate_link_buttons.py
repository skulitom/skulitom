"""Generate compact, self-contained static SVG links for the GitHub profile.

The original v1 artwork is retained for cached pages. The current pixel-art
buttons are generated by generate_pixel_buttons.py.
"""
